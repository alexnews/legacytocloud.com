      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link href="/demo/dashboard" className="text-slate-400 hover:text-white text-sm transition-colors">
                  Dashboard
                </Link>
              </li>
              <li>
                <Link href="/demo/architecture" className="text-slate-400 hover:text-white text-sm transition-colors">
                  Architecture
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              {['Python', 'FastAPI', 'PostgreSQL', 'ClickHouse', 'Next.js'].map((tech) => (
                <li key={tech}>
        ...
        <div className="border-t border-slate-800 mt-10 pt-8 text-center">
          <p className="text-sm text-slate-500">
            &copy; 2025 LegacyToCloud. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
